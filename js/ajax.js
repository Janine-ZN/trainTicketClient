...
//var httpctx='http://114.214.170.75:8080/apiticket';     // 于磊磊
var httpctx='http://114.214.164.48:8080/apiticket';       // Janine
  	    ...
  	    mui.ajax(httpctx +'/checkUser.do',{
			...
			success:function(data){
				...
				if(data.flag == true){
					...
					//mui.toast("请求服务器失败！");      //祁凯宁20170104修改
				}
			},
			error : function(data){  
	...
	w.ajax_login = function(options){
        ...
        //检测验证码
  	    mui.ajax(httpctx +'/loginUser.do',{
			...
			error : function(data){  
		 	  // 	mui.alert("ajax_login 请查看网络!");  //祁凯宁20170104修改
		 	  	ajax_getPassCodeNew({});
	 	   }
		});
	}
